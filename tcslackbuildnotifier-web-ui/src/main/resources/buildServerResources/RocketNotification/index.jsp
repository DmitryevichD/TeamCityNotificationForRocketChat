    ...
    <script type=text/javascript>
		...
		BS.SlackNotificationForm = OO.extend(BS.AbstractWebForm, {
			  ...
			  removeSlackNotification : function(paramId) {
			    ...
			    if (!confirm("Are you sure you want to delete this RocketNotification?")) return;
    ...
    <div class="editBuildPageGeneral" style="background-color:white; float:left; margin:0; padding:0; width:70%;">
        ...
        <c:choose>
    		<c:when test="${haveBuild}">
			    ...
			    To edit all rocket notifications for builds in the project <a href="index.html?projectId=${projectExternalId}">edit Project rocketnotifications</a>.
         	</c:when>
         	<c:otherwise>
