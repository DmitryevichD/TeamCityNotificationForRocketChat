package rocketnotifications.teamcity.payload.content;
...
import rocketnotifications.teamcity.RocketNotificator;
...
/*
    ...
    private void populateCommonContent(SBuildServer server, SRunningBuild sRunningBuild, SFinishedBuild previousBuild,
        ...
        if (sRunningBuild.getTriggeredBy().getUser() != null) {
            setTriggeredBySlackUserId(sRunningBuild.getTriggeredBy().getUser().getPropertyValue(RocketNotificator.USERID_KEY));
        }
