...
import static rocketnotifications.teamcity.BuildStateEnum.*;
...
public class BuildState {
    ...
    /**
     * Takes the currentBuildState, for which the RocketNotification is being triggered
     * and compares it against the build states for which this RocketNotification is configured
     * to notify.
     * 
     * @param currentBuildState
     * @param buildStatesToNotify
     * @return Whether or not the rocketnotifications should trigger for the current build state.
     */
