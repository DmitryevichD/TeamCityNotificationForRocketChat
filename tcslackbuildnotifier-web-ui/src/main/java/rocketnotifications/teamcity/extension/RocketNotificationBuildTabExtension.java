...
public class RocketNotificationBuildTabExtension extends BuildTypeTab {

	private static final String  SLACK_NOTIFICATIONS = "rocketNotifications";
	RocketNotificationProjectSettings settings;
	ProjectSettingsManager projSettings;
	String myPluginPath;

	protected RocketNotificationBuildTabExtension(
	...
	protected void fillModel(Map model, HttpServletRequest request,
		...
		this.settings =
			(RocketNotificationProjectSettings)this.projSettings.getSettings(buildType.getProject().getProjectId(), ROCKET_NOTIFICATIONS_SETTINGS_ATTRIBUTE_NAME);
...
//
	...
	public String getIncludeUrl() {
		//return myPluginPath + "RocketNotification/buildSlackNotificationTab.jsp";
