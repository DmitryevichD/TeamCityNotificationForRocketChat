...
public class RocketNotificationAjaxSettingsListPageController extends BaseController {
	...
	private final RocketNotificationPayloadManager myManager;
	    ...
	    public RocketNotificationAjaxSettingsListPageController(SBuildServer server, WebControllerManager webManager,
                                                                ProjectSettingsManager settings, RocketNotificationPayloadManager manager, PluginDescriptor pluginDescriptor,
                                                                RocketNotificationMainSettings mainSettings) {
	        super(server);
	    ...
	    public void register(){
	      myWebManager.registerController("/rocketnotifications/settingsList.html", this);
	    }
	    ...
	    protected ModelAndView doHandle(HttpServletRequest request, HttpServletResponse response) throws Exception {
	        ...
	        if(request.getParameter(PROJECT_ID) != null 
		    	...
		    	RocketNotificationProjectSettings projSettings = (RocketNotificationProjectSettings)
		    			mySettings.getSettings(request.getParameter(PROJECT_ID), ROCKET_NOTIFICATIONS_SETTINGS_ATTRIBUTE_NAME);
	        ...
	        return new ModelAndView(myPluginDescriptor.getPluginResourcesPath() + "RocketNotification/settingsList.jsp", params);
	        //return new ModelAndView("/RocketNotification/settingsList.jsp", params);
	    }
}
