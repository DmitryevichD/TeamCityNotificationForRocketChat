...
import rocketnotifications.teamcity.settings.converter.SlackNotificationBuildStateConverter;
...
public class SlackNotificationConfig {
     ...
     * It will still allow you to add the format, but the rocketnotifications might not
