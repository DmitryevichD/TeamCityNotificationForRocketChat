...
public class RocketNotificator implements Notificator {

    private final RocketNotificationMainSettings mainConfig;
    private final SlackNotificationFactory notificationFactory;
    private final RocketNotificationPayloadManager payloadManager;
    private final SBuildServer buildServer;
    private ArrayList<UserPropertyInfo> userProps;
    private NotificationUtility notificationUtility;

    private static final String SLACK_USERID_KEY = "rocketNotifier.userId";
    private static final String TYPE = "rocketBuildNotifier";

    public static final PropertyKey USERID_KEY = new NotificatorPropertyKey(TYPE, SLACK_USERID_KEY);

    public RocketNotificator(NotificatorRegistry notificatorRegistry,
    ...
    private SlackNotification createNotification(SUser sUser) {
        ...
        notification.setRocketUrl(mainConfig.getRocketUrl());
