 ...
 */
public class RocketNotifierAdminPage extends AdminPage {


    private static final String AFTER_PAGE_ID = "jabber";
    private static final String BEFORE_PAGE_ID = "clouds";
    private static final String PAGE = "RocketNotification/slackAdminSettings.jsp";
    ...
    private RocketNotificationMainSettings slackMainSettings;

    protected RocketNotifierAdminPage(@NotNull PagePlaces pagePlaces,
                                      @NotNull PluginDescriptor descriptor,
                                      @NotNull SBuildServer sBuildServer,
                                      @NotNull RocketNotificationMainSettings slackMainSettings
                                     ) {
        super(pagePlaces);
