...
public class SlacknotificationConfigAndBuildTypeListHolder {
	...
	public SlacknotificationConfigAndBuildTypeListHolder(SlackNotificationConfig config, RocketNotificationMainSettings mainSettings) {
        ...
        botName = valueOrFallback(config.getContent().getBotName(), RocketNotificationMainConfig.DEFAULT_BOTNAME);
        iconUrl = valueOrFallback(config.getContent().getIconUrl(), RocketNotificationMainConfig.DEFAULT_ICONURL);
	}
